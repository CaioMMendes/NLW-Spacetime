...
const newMemory = () => {
    ...
    const handleCreateMemory = async () => {
        ...
        await api.post('/memories', { content, isPublic, coverUrl }, {
            headers: {
        ...
        <ScrollView className="flex-1 px-8" contentContainerStyle={{ paddingBottom: bottom, paddingTop: top }}>
            ...
            <View className="mt-6 space-y-6">
                ...
                <TouchableOpacity
                    ...
                    activeOpacity={0.7} className="h-32 items-center justify-center rounded-lg border border-dashed border-gray-500 bg-black/20">
                    {preview ? (
                ...
                <TextInput
                    ...
                    multiline className="p-0 font-body text-lg text-gray-50" placeholderTextColor={'#56565a'} placeholder="Fique livre para adicionar fotos, vídeos e relatos sobre essa experiência que você quer lembrar para sempre.">
